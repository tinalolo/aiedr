...
const Container: any = styled.div`
    /* width: ${(props: any) => (props.changeWidth == '2') ? '50%' : '100%'}; */
    height: 0;
    /* padding-bottom: 56.25%; */
    padding-bottom: ${(props: any) => (props.changeWidth >= '3') ? '45.75%' : '53.25%'};//原本56.25%
    position: relative;
...
const LiveStreamingPlayer = (P:any) => {
    const { cameraPlayItem } = useDashboardStore();
    const { motionList, setMotionList, isMotionEditMode, setSelectedMotionId, selectedCameraSnapshot, setCheckOne, checkOne } = useVideoStore();
    ...
    return (
        <Container id="container" ref={ref} changeWidth={checkOne} className={P.className}>
